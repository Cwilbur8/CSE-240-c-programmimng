...
//below.
printf("Explanation: The macro associated to this function made the value of x be incremented twice instead of just one time.\n\n\n"); // (3 points)
}
// Part 2:
...
printf("Explanation: Compilers that are different can solve functions with different orders and this causes different answers. \n\n"); // (3 points)
}
// Do not edit main()
int main()
{
